...
config.read('database_Payroll_DB.properties')
...
query = "SELECT DatabaseName, TableName, CreateTimeStamp, LastAlterTimeStamp FROM dbc.Tables WHERE TableKind = 'T' and DatabaseName = 'Payroll_DB' ORDER BY TableName;"
